...
export function SystemPanel() {
  return (
    <section className="relative py-[14vh]" aria-labelledby="system-heading">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,transparent,rgba(10,10,11,0.94)_16%,rgba(10,10,11,0.94)_84%,transparent)]"
      />
