...
export function Capabilities() {
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(to_bottom,transparent,rgba(var(--ground-rgb),0.94)_18%,rgba(var(--ground-rgb),0.94)_82%,transparent)]"
      />
