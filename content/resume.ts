...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    aside:
      "Der Ton auf dieser Seite ist kein Sample. Drei leicht verstimmte Oszillatoren laufen durch einen Biquad-Tiefpass und einen Delay-Bus. Die Platte im Hintergrund wird von der 512-Punkt-FFT desselben Graphen ausgelenkt, Punkt für Punkt im Shader gerechnet, und der Sand darauf sammelt sich dort, wo sie still steht. Die Filterfrequenz färbt nebenbei das Licht der ganzen Seite.",
    skills: [
      "Mixing & Mastering",
      "Recording",
      "Live-Tontechnik",
